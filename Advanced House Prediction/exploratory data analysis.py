...
# 1. Missing values
null_features = [features for features in train_data.columns 
...
'''We have 4 year variables in dataset. We have extract information from the 
datetime variables like no of year, no of days. We have used name to extract.'''
year_feature = [feature for feature in numerical_data 
                        if 'Yr' in feature or 'Year' in feature
                ]
print(feature, numerical_data[year_feature].head())
...
# We are checking SalePrice with repect no of years
...
discrete_feature = [feature for feature in numerical_data 
                            if len(numerical_data[feature].unique())<25 
...
continous_feature = [feature for feature in numerical_data 
...
categorical_data = train_data.select_dtypes(include='O')
print(categorical_data.head())
'''cardinality means no. of unique category in categorical feature.'''

# Cardinality of Categorical Features
for feature in categorical_data:
    print(feature, len(categorical_data[feature].unique()))
